    ...
    companion object {
        ...
        private val MIGRATION_14_15: Migration = object : Migration(14, 15) {
            override fun migrate(database: SupportSQLiteDatabase) {
                ...
                database.execSQL("INSERT INTO user(user_id, first_name, email, email_verified, status, primary_currency, valid_password, register_steps, registration_date, facebook_id, attribution, last_name, mobile_number, gender, residential_address, mailing_address, previous_address, household_size, marital_status, occupation, industry, date_of_birth, driver_license, features, foreign_tax, tax_residency, external_id) SELECT user_id, first_name, email, email_verified, status, primary_currency, valid_password, register_steps, registration_date, facebook_id, attribution, last_name, mobile_number, gender, residential_address, mailing_address, previousAddress, household_size, marital_status, occupation, industry, date_of_birth, driver_license, features, foreign_tax, tax_residency, external_id FROM original_user")
                database.execSQL("DROP TABLE original_user")
                database.execSQL("CREATE INDEX IF NOT EXISTS `index_user_user_id` ON `user` (`user_id`)")
                database.execSQL("COMMIT")
