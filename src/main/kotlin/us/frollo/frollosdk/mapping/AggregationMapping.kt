...
internal fun AccountResponse.toAccount(): Account =
    Account(
        ...
        hidden = hidden,
        refreshStatus = refreshStatus,
        primaryBalance = primaryBalance?.let { Balance.getBalanceWithDefaultCurrencyIfMissing(it) },
        secondaryBalance = secondaryBalance?.let { Balance.getBalanceWithDefaultCurrencyIfMissing(it) },
